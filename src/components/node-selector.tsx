...
const executionNodes: NodeTypeOption[] = [
  ...
  },
  {
    ...
    label: "Discord",
    description: "Use Discord to send message",
    icon: "/logos/discord.svg",
  },
  {
    type: NodeType.SLACK,
    label: "Slack",
    description: "Use slack to send message",
        ...
        <div>
          {triggerNodes.map((nodeType) => {
            ...
            return (
              <div
                key={nodeType.type}
                className="w-full flex items-center gap-6 justify-start h-auto py-5 px-4 cursor-pointer border-l-2 border-transparent hover:border-l-primary"
